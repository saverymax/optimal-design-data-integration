...
exp_col <- c("model-1_prop-0.01", "model-1_prop-0.05","model-1_prop-0.1","model-1_prop-0.2", "model-1_prop-0.5", "model-1_prop-1","model-2_prop-0.01")
...
#}
v_mat <- matrix(nrow=length(exp_col))
print(dim(v_mat))
for (i in 1:length(exp_col)){
