...
To get started, please clone or copy the repository and follow along with the documentation here. Make sure all folders provided in the figshare repository are unzipped. All source code is available in the ```optimal-design-data-integration``` directory. After following the installation instructions, please go to the data section and follow the setup there. 
