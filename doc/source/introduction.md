...
To get started, please clone or copy the repository and follow along with the documentation here. Before either simulated or applied experiments can be run, it is necessary to create the datasets for each. After following the installation instructions, please go to the data section and follow the setup there. 
