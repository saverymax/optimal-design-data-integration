...
parser <- add_option(parser, "--po_data_file", type="character", help="File name of PO data to use in optimization")
...
if (exp_args$use_sim_po==T){
  r_po_data <- readRDS(file=file.path(exp_args$working_dir, "data", "sim_data", exp_args$po_data_file))
  print(r_po_data)
