...
We have also provided all data necessary to reconstruct the ```data_pack.RDS``` in the zipped ```raw_data``` folder in the figshare repository <https://doi.org/10.6084/m9.figshare.25450108>. In this case you may skip to the [data processing](#processing-data) section below so that you don't have to download the data from their respective source sites.
